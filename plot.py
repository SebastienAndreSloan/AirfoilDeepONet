...
def plot2d(dataset_list, dataset_name, net, device):
  ...
  sc0 = ax[0, 0].scatter(x1_position_bulk, x2_position_bulk, c = y_pred[:, 0], s = 0.75)
  ax[0, 0].title.set_text('Pressure')
  plt.colorbar(sc0)
  sc1 = ax[0, 1].scatter(x1_position_bulk, x2_position_bulk, c = y_pred[:, 1], s = 0.75)
  ax[0, 1].title.set_text('Velocity along x')
  plt.colorbar(sc1)
  sc2 = ax[1, 0].scatter(x1_position_bulk, x2_position_bulk, c = y_pred[:, 2], s = 0.75)
  ax[1, 0].title.set_text('Velocity along y')
  plt.colorbar(sc2)
  sc3 = ax[1, 1].scatter(x1_position_bulk, x2_position_bulk, c = y_pred[:, 3], s = 0.75)
  ax[1, 1].title.set_text('Kinematic turbulent viscosity')
  plt.colorbar(sc3)
  plt.show()

  fig, ax = plt.subplots(2, 2, figsize = (36, 12))
  sc0 = ax[0, 0].scatter(x1_position_bulk, x2_position_bulk, c = dataset_list[-1][:,9], s = 0.75)
  ax[0, 0].title.set_text('True Pressure')
  plt.colorbar(sc0)
  sc1 = ax[0, 1].scatter(x1_position_bulk, x2_position_bulk, c = dataset_list[-1][:,7], s = 0.75)
  ax[0, 1].title.set_text('Velocity along x')
  plt.colorbar(sc1)
  sc2 = ax[1, 0].scatter(x1_position_bulk, x2_position_bulk, c = dataset_list[-1][:,8], s = 0.75)
  ax[1, 0].title.set_text('Velocity along y')
  plt.colorbar(sc2)
  sc3 = ax[1, 1].scatter(x1_position_bulk, x2_position_bulk, c = dataset_list[-1][:,10], s = 0.75)
  ax[1, 1].title.set_text('Kinematic turbulent viscosity')
  plt.colorbar(sc3)
  plt.show()